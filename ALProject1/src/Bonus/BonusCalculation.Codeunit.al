codeunit 65400 "MNB Bonus Calculation"
{
    ...
    local procedure InsertBonusEntry(var BonusLine: Record "MNB Bonus Line Type"; var SalesInvLine: Record "Sales Invoice Line")
    var
    ...
    begin
        ...
        BonusEntry."Bonus Amount" := (BonusLine."Bonus Perc." / 100) * SalesInvLine."Line Amount";

        OnBeforeInsertBonusEntry(BonusEntry, SalesInvLine);
        BonusEntry.Insert();
        OnAfterInsertBonusEntry(BonusEntry, SalesInvLine);
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertBonusEntry(var BonusEntry: Record "MNB Bonus Entry"; var SalesInvLine: Record "Sales Invoice Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterInsertBonusEntry(var BonusEntry: Record "MNB Bonus Entry"; var SalesInvLine: Record "Sales Invoice Line")
    begin
    end;
}